...
class Chosen extends AbstractChosen
  ...
  set_up_html: ->
    ...
    if @is_multiple
      ...
      @container.html '<a class="chosen-single chosen-default" tabindex="-1"><span class="chosen-default-text">' + @default_text + '</span><div class="chosen-btn"><b class="chosen-btn-icon"></b></div></a><div class="chosen-drop"><div class="chosen-search"><input type="text" autocomplete="off" /></div><ul class="chosen-results"></ul></div>'
